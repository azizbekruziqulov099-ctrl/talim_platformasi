...
ENGINE_RELEASE = "SAMTM-TIMETABLE-ENGINE-V3-6REALMODE"
...
MODE_CONFIG = {
    1: {"stage": "strict", "repeat_days": 0, "attempts": 6, "imbalance_limit": 0, "strategy": "pedagogik", "nomi": "Qat'iy", "izoh": "Barcha pedagogik va qat'iy qoidalar to'liq saqlanadi."},
    2: {"stage": "light", "repeat_days": 0, "attempts": 6, "imbalance_limit": 0, "strategy": "ehtiyotkor", "nomi": "Ehtiyotkor", "izoh": "Faqat 5-darsdagi og'ir/yengil fan tavsiyasi yumshaydi."},
    3: {"stage": "balanced", "repeat_days": 0, "attempts": 5, "imbalance_limit": 1, "strategy": "muvozanat", "nomi": "Muvozanatli", "izoh": "Sinf va o'qituvchi qulayligi teng baholanadi."},
    4: {"stage": "flexible", "repeat_days": 0, "attempts": 5, "imbalance_limit": 2, "strategy": "ixcham", "nomi": "Moslashuvchan", "izoh": "Barcha soatni oknosiz sig'dirish ustun turadi."},
    5: {"stage": "fit_all", "repeat_days": 1, "attempts": 5, "imbalance_limit": 3, "strategy": "sigdirish", "nomi": "Kuchli", "izoh": "Zaruratda aynan bir fan haftada 1 kun ikki marta qo'yilishi mumkin."},
    6: {"stage": "emergency", "repeat_days": 2, "attempts": 6, "imbalance_limit": 4, "strategy": "oxirgi", "nomi": "Oxirgi", "izoh": "Zaruratda aynan bir fan haftada 2 kungacha ikki marta qo'yilishi mumkin."},
}
