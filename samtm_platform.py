...
# Railway eski start buyrug'i bilan `samtm_platform:app` ni ochsa ham
# institut V20 endpointlari 404 bo'lib qolmasin. `register_institute`
# idempotent: `main:app` ishlatilganda router ikkinchi marta qo'shilmaydi.
try:
    from . import samtm_institute as _samtm_institute_v20
except ImportError:
    import samtm_institute as _samtm_institute_v20
_samtm_institute_v20.register_institute(app, sys.modules[__name__])
