"""Production runtime for SamTM V19.2.
...
def register_runtime(app, platform, school):
    ...
    def live(): return {"status":"ok","version":"v19.2","schema":SCHEMA_VERSION}
    ...
    def ready():
        ...
        try:
            ...
            return {"status":"ready","version":"v19.2","db":bool(cur.fetchone()["ok"]),"schema_version":SCHEMA_VERSION,"schema_ready":len(_SCHEMA_READY)}
        finally:
